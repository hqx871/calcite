...
class TpcdsTest {
  ...
  @Disabled("it's wasting time to count each table")
    ...
    checkQuery(17)
        ...
        .explainMatches("including all attributes ",
            CalciteAssert.checkMaskedResultContains(""
                ...
                + "    EnumerableSort(sort0=[$0], sort1=[$1], sort2=[$2], dir0=[ASC], dir1=[ASC], dir2=[ASC]): rowcount = 5.434029018852197E26, cumulative cost = {1.2435775409784036E28 rows, 1.317577974149368E30 cpu, 0.0 io}\n"
